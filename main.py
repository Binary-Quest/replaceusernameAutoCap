...
<b>• Developer : [Binary Quest](https://t.me/binaryquest)</b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/BinaryQuest>Click Here</a></b>
<b>• Source Code : <a href=https://t.me/Itz_Sahil_Official>Click Here</a></b>"""
    ...
    if os.environ.get("custom_caption"):
        ...
        try:
            ...
            if caption:
                ...
                caption = re.sub(r"@[A-Za-z0-9_]+", "@BinaryQuest", caption)
                # Append desired text
                caption += "\n\n<b>〽🖤Join : @BinaryQuest ☠️</b>"
                update.edit(caption)
...
def start_buttons(bot, update):
    bot = bot.get_me()
    buttons = [[
        pyrogram.types.InlineKeyboardButton("Updates", url="t.me/BinaryQuest"),
